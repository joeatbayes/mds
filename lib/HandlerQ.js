...
function Q(server, req, resp, extraPath, config)
{
  ...
  /*    
   http://mds1.company.com:8300/mds
   http://mds1.company.com:8300/mds?v=8.2
   http://mds1.company.com:8300/mds?rt=sp,sploc,spglobmet
   http://mds1.company.com:8300/mds?v=8.2&rt=sp,sploc,spglobmet
   --POST String--
  ...
  */
  ...
  {
    var q = parse_query();
    console.log("L88: handle_post q=" + JSON.stringify(q));
  ...
  // http://mds1.company.com:8300/mds/10181X3/8.2/sp 
  // http://mds1.company.com:8300/mds/10181X3/8.2?rt=sp,sploc,spglogmet,spbestrev 
  // http:/127.0.0.1:9839/mds?rt=sp,sploc,spglogmet,spbestrev&v=8.2&id=10181X3,10189X2,101817,918187,08989
  function handle_GET() 
  {    
    var q = parse_query();    
